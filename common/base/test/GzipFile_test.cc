...
int main()
{
  ...
  {
  WJ::GzipFile writer = WJ::GzipFile::openForAppend(filename);
  if (writer.valid())
  {
  ...
  WJ::GzipFile reader = WJ::GzipFile::openForRead(filename);
  if (reader.valid())
  {
    char buf[256];
  ...
  {
  WJ::GzipFile writer = WJ::GzipFile::openForWriteExclusive(filename);
